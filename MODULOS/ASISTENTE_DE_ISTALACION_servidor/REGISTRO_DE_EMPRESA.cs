            ...
            else
            {
                if (txtEmpresa.Text != "")
                {
                    if (txtRuta.Text != "")
                    {
                        ...
                        Dispose();
                        MODULOS.ASISTENTE_DE_ISTALACION_servidor.USUARIOS_AUTORIZADO_AL_SISTEMA frm = new MODULOS.ASISTENTE_DE_ISTALACION_servidor.USUARIOS_AUTORIZADO_AL_SISTEMA();
                        frm.ShowDialog();
