...
namespace PUNTO_DE_VENTA.sevendePor.ASISTENTE_DE_ISTALACION_servidor
{
    public partial class Eleccion_Servidor_o_remoto : Form
    {
        ...
        {
            Dispose();
            sevendePor.ASISTENTE_DE_ISTALACION_servidor.Instalacion_del_servidorSQL frm = new sevendePor.ASISTENTE_DE_ISTALACION_servidor.Instalacion_del_servidorSQL();
            frm.ShowDialog();
