...
namespace PUNTO_DE_VENTA.presentacion.ASISTENTE_DE_ISTALACION_servidor
{
            ...
            else
            {
                if (txtEmpresa.Text != "")
                {
                    if (txtRuta.Text != "")
                    {
                        ...
                        Dispose();
                        presentacion.ASISTENTE_DE_ISTALACION_servidor.USUARIOS_AUTORIZADO_AL_SISTEMA frm = new presentacion.ASISTENTE_DE_ISTALACION_servidor.USUARIOS_AUTORIZADO_AL_SISTEMA();
                        frm.ShowDialog();
