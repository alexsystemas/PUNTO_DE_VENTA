...
namespace PUNTO_DE_VENTA.sevendePor.VENTAS_MENU_PRINCIPAL
{
    public partial class MEDIOS_DE_PAGO : Form
    {
        ...
        {
            sevendePor.REPORTES.Impresion_de_comprobantes.Ticket_report rpt = new sevendePor.REPORTES.Impresion_de_comprobantes.Ticket_report();
            DataTable dt = new DataTable();
            try
            {
                CONEXION.CONEXIONMAESTRA.abrir();
                ...
                da.Fill(dt);
                rpt = new sevendePor.REPORTES.Impresion_de_comprobantes.Ticket_report();
