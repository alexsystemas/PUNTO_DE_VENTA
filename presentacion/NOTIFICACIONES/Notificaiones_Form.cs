...
namespace PUNTO_DE_VENTA.sevendePor.NOTIFICACIONES
{
    public partial class Notificaiones_Form : Form
    {
        public Notificaiones_Form()
        {
            InitializeComponent();
        }
        private void Dibujar_Productos_Vencidos()
        {
            try
            {
                ...
                while (rdr.Read())
                {
                    ...
                    b.Size = new System.Drawing.Size(340, 35);
                    ...
                    I2.BackgroundImage = Properties.Resources.precaucion;
                    ...
                    I1.BackgroundImage = Properties.Resources.vencimento;
                    ...
                    PANEL_CONTENEDOR_NOTIFICAIONES.Controls.Add(p1);
        ...
        private void Notificaiones_Form_Load(object sender, EventArgs e)
        {
