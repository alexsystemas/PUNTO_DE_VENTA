    ...
    private void MOSTRAR_PERMISOS()
        ...
        private void Timer1_Tick(object sender, EventArgs e)
        {
            ...
            if (INDICADOR == "CORRECTO")
            {
                ...
                {
                    Hide();
                    sevendePor.ASISTENTE_DE_ISTALACION_servidor.REGISTRO_DE_EMPRESA frm = new sevendePor.ASISTENTE_DE_ISTALACION_servidor.REGISTRO_DE_EMPRESA();
                    frm.ShowDialog();
                    Dispose();
                }
            ...
            {
                Hide();
                sevendePor.ASISTENTE_DE_ISTALACION_servidor.Eleccion_Servidor_o_remoto frm = new sevendePor.ASISTENTE_DE_ISTALACION_servidor.Eleccion_Servidor_o_remoto();
                frm.ShowDialog();
                Dispose();
            }
            // timer1.Stop();
            ...
            if (lblEstadoLicencia.Text != "VENCIDO")
            {
                ...
                if(txtfecha_final_licencia_temporal.Value >= fecha_ddmmyy)
                {
                    ...
                    {
                       Hide();
                        sevendePor.LICENCIAS_MEMBRESIAS.Membresias frm = new sevendePor.LICENCIAS_MEMBRESIAS.Membresias();
                        frm.ShowDialog();
                        Dispose();
                    }
                }
