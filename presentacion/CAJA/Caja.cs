...
namespace PUNTO_DE_VENTA.sevendePor.CAJA
{
    public partial class Caja : Form
    {
        ...
        private void dibujarCAJA_PRINCIPAL()
        {
            try
            {
                ...
                while (rdr.Read())
                {
                    ...
                    ToolStripPRINCIPAL.Image = Properties.Resources.cronograma;
        ...
        private void miEventoToolStripEDITAR(System.Object sender, EventArgs e)
        {
            ...
            panelEdicion_de_caja.Location = new Point((panel16.Width - panelEdicion_de_caja.Width) / 2, (panel16.Height - panelEdicion_de_caja.Height) / 2);
            txtcaja.SelectAll();
            txtcaja.Focus();
        }
