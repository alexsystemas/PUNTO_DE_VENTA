...
namespace PUNTO_DE_VENTA.sevendePor.PRODUCTOS_OK
{
    public partial class Productos_OK : Form
    {
        ...
        {
            Dispose();
            sevendePor.CONFIGURACION.PANEL_CONFIGURACIONES frm = new sevendePor.CONFIGURACION.PANEL_CONFIGURACIONES();
            frm.ShowDialog();
        }
        ...
        {
            sevendePor.PRODUCTOS_OK.Asistente_de_ImportacionExcel frm = new sevendePor.PRODUCTOS_OK.Asistente_de_ImportacionExcel();
            frm.ShowDialog();
        }
