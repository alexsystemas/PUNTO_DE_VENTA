...
namespace PUNTO_DE_VENTA.sevendePor.INVENTARIOS_KARDEX
{
    public partial class INVENTARIO_MENU : Form
    {
        ...
        {
            sevendePor.REPORTES.REPORTES_DE_KARDEX_listo.REPORTE_DE_INVENTARIOS_todos.FormMovBuscar frm = new sevendePor.REPORTES.REPORTES_DE_KARDEX_listo.REPORTE_DE_INVENTARIOS_todos.FormMovBuscar();
            frm.ShowDialog();
        }
